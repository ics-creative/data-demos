...
module project {
	...
	export class Main {
		...
		menu:Menu;
		manifest:any[] = [
//			{src: "http://clockmaker.jp/labs/150128_clock_webgl/img/more_complications_large_2x.png", id: "AppleWatch"}
		...
		private spriteSheetBuilder:createjs.SpriteSheetBuilder;
		private maskShape;
		...
		private handleComplete() {
			...
			var numBg = this.spriteSheetBuilder.addFrame(new createjs.Bitmap(<HTMLImageElement>loader.getResult("AppleWatch")));
	...
	class ImageGenerator {
		static build(builder:createjs.SpriteSheetBuilder, numItems:number, iconUnicodeList:string[]) {
