    ...
    var Main = (function () {
        ...
        Main.prototype.handleTick = function () {
            ...
            for (var i = 0; i < this.pathList.length - 1; i++) {
                ...
                gCurve.beginStroke(createjs.Graphics.getHSL(200 + ((p.percent) * 60), 60, 50 + Math.random() * 10)).moveTo(curveStartX, curveStartY).curveTo(p1x, p1y, curveEndX, curveEndY).endStroke();
            }
