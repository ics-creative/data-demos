...
interface mat4 {
	...
	multiply(dest : Float32Array,mat : Float32Array, mat2 : Float32Array) : Float32Array;
	...
	perspective(dest : Float32Array,fovy : number, aspect : number, near : number, far : number) : Float32Array;
	ortho(left : number, right : number, bottom : number, top : number, near : number, far : number, dest ?: Float32Array) : Float32Array;
	lookAt(dest : Float32Array,eye : Float32Array, center : Float32Array, up : Float32Array) : Float32Array;
